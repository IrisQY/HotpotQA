...
import argparse
from train_classifier import train_classifier, test_classifier, predict_classifier, evaluate_batch_classifier
from select_sentence import try_to_select_sentence

parser = argparse.ArgumentParser()

glove_word_file = "glove.840B.300d.txt"

questions_file = "toy_dev_small.json"
...
elif config.mode == 'select_sentence':
    try_to_select_sentence(config)

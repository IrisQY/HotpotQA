...
def _process_article(article, config):
    ...
    for para in paragraphs:
        ...
        para_sent_lens.append(len(para[1]))
    ...
    # para_sent_lens = torch.tensor(para_sent_lens).view(-1)
    example = {'context_tokens': context_tokens,'context_chars': context_chars, 'ques_tokens': ques_tokens, 'ques_chars': ques_chars, 'y1s': [best_indices[0]], 'y2s': [best_indices[1]], 'id': article['_id'], 'start_end_facts': start_end_facts, 'para_sent_lens': para_sent_lens}

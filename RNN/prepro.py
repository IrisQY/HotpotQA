...
def _process_article(article, config):
    ...
    example = {'context_tokens': context_tokens,'context_chars': context_chars, 'ques_tokens': ques_tokens, 'ques_chars': ques_chars, 'y1s': [best_indices[0]],
               'y2s': [best_indices[1]], 'id': article['_id'], 'start_end_facts': start_end_facts, 'para_sent_lens': para_sent_lens} ###
...
#        ques_idxs[:question_idxs_pre_padded.size()[0],:] = question_idxs_pre_padded
        ...
        datapoints.append({'context_idxs': context_idxs,
            ...
            'para_sent_lens': example['para_sent_lens']})
